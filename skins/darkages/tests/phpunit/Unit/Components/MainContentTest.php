...
use Skins\Darkages\Components\MainContent;

/**
 * @coversDefaultClass \Skins\Darkages\Components\MainContent
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class MainContentTest extends GenericComponentTestCase {
	...
	protected $classUnderTest = '\Skins\Darkages\Components\MainContent';
	...
	public function testGetHtml_OnEmptyDataProperty() {
		...
		$instance = new MainContent( $darkagesTemplate );

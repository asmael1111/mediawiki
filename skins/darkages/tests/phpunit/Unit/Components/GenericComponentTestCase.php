...
use Skins\Darkages\Tests\Util\DocumentElementFinder;
...
class GenericComponentTestCase extends TestCase {
	...
	public function getTestObject( \DOMElement $domElement = null ) {
		if ( $this->testObject === null ) {
			...
			$this->testObject = new $this->classUnderTest( $darkagesTemplate, $domElement );
		}
	...
	/**
	 * @return \Skins\Darkages\DarkagesTemplate
	 * @throws \MWException
	 */
	public function getDarkagesSkinTemplateStub() {
		return MockupFactory::makeFactory( $this )->getDarkagesSkinTemplateStub();
	}
	...
	public function getNameOfComponentUnderTest() {
		return str_replace( 'Skins\\Darkages\\Components\\', '', get_class( $this->getTestObject() ) );
	}

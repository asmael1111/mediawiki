...
namespace Skins\Darkages\Tests\Unit\Components\Modifications;

/**
 * @coversDefaultClass \Skins\Darkages\Components\Modifications\ShowOnlyFor
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class ShowOnlyForTest extends GenericModificationTestCase {
	...
	protected $classUnderTest = '\Skins\Darkages\Components\Modifications\ShowOnlyFor';

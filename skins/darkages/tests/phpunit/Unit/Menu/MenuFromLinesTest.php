...
namespace Skins\Darkages\Tests\Unit\Menu;

use Skins\Darkages\Menu\MenuFromLines;

/**
 * Class MenuFromLinesTest
 *
 * @coversDefaultClass \Skins\Darkages\Menu\MenuFromLines
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class MenuFromLinesTest extends \PHPUnit\Framework\TestCase {
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			'Skins\Darkages\Menu\MenuFromLines',
			$instance
		);
	}

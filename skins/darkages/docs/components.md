...
``` xml
<structure xmlns="https://github.com/ProfessionalWiki/darkages/layout/1.0">
  ...
</structure>
```
...
* `showTogglerText`:
  ...
  * Optional.
  ...
  Displays text next to the toggler icon. The text is defined in the system message `darkages-toggler`.
...
* `flatten`
  ...
  * Optional.
  ...
  _MediaWiki:skin-darkages-navmenu-flatten_ instead. If both the message and

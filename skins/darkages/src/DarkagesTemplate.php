<?php
/**
 * File holding the DarkagesTemplate class
 *
...
/**
 * BaseTemplate class for the Darkages skin
 *
 * @author Stephan Gambke
 * @since 1.0
 * @ingroup Skins
 */
class DarkagesTemplate extends BaseTemplate {
	 ...
	 *
	 * @throws \MWException
	 * @return \Skins\Darkages\Components\Container
	 */

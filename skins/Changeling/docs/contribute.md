...
There are different ways to make a contribution to Changeling. A few guidelines
...
* Expected result
* Observed result
* Versions of PHP, MediaWiki, Changeling, Browsers, other relevant software (web server, MediaWiki extensions)
...
* You may provide a [screenshot][screenshots] of the Changeling skin used on
...
The Changeling skin is hosted on GitHub. To provide patches you need to get an
account.
...
[changeling]: https://www.mediawiki.org/wiki/Skin:Changeling
...
[screenshots]: https://www.mediawiki.org/wiki/Skin:Changeling#Screenshots
[twn]: https://translatewiki.net/
[twn-stats]: https://translatewiki.net/wiki/Special:MessageGroupStats?group=mwgithubskin-changeling&x=D

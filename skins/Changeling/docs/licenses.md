...
You can use the Changeling skin under the [GNU General Public License, version
3](https://www.gnu.org/copyleft/gpl.html) (or any later version). See the
relevant [license statement](../COPYING).

The documentation of the Changeling skin is published under the [GNU Free
...
The ["Changeling Skin Logo"](Changeling.svg) was derived from the ["Changeling free
...
3.0](http://creativecommons.org/licenses/by/3.0/). The "Changeling Skin Logo"

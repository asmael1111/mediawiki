...
``` xml
<structure xmlns="https://github.com/ProfessionalWiki/changeling/layout/1.0">
  ...
</structure>
```
...
* `showTogglerText`:
  ...
  * Optional.
  ...
  Displays text next to the toggler icon. The text is defined in the system message `changeling-toggler`.
...
* `flatten`
  ...
  * Optional.
  ...
  _MediaWiki:skin-changeling-navmenu-flatten_ instead. If both the message and

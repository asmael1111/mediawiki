...
by the Changeling skin (although not all of the variables are actually used). 
...
Changeling skin directly. Instead use the methods described in
...
-------------------------------------------------------|----------------------
 ...
 $theme-colors                                         | ("primary": #007bff, "secondary": #6c757d, "success": #28a745, "info": #17a2b8, "warning": #ffc107, "danger": #dc3545, "light": #e9ecef, "dark": #343a40, "error": #dc3545, "darker": #003366)
 $thumbnail-bg                                         | #fff

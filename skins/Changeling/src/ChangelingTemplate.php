<?php
/**
 * File holding the ChangelingTemplate class
 *
...
/**
 * BaseTemplate class for the Changeling skin
 *
 * @author Stephan Gambke
 * @since 1.0
 * @ingroup Skins
 */
class ChangelingTemplate extends BaseTemplate {
	 ...
	 *
	 * @throws \MWException
	 * @return \Skins\Changeling\Components\Container
	 */

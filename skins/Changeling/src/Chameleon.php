<?php
/**
 * File holding the SkinChangeling class
 *
...
/**
 * SkinTemplate class for the Changeling skin
 *
 * @author Stephan Gambke
 * @since 1.0
 * @ingroup Skins
 */
class Changeling extends SkinTemplate {

	public $skinname = 'Changeling';
	public $stylename = 'Changeling';
	public $template = '\Skins\Changeling\ChangelingTemplate';
	...
	public static function init() {
		...
		if ( DIRECTORY_SEPARATOR === '/' && $GLOBALS[ 'egChangelingLayoutFile' ][0] !== '/' ) {
			$GLOBALS[ 'egChangelingLayoutFile' ] = $GLOBALS[ 'wgStyleDirectory' ] . '/Changeling/' .
				$GLOBALS[ 'egChangelingLayoutFile' ];
		}
	}
	...
	public function initPage( OutputPage $out ) {
		...
		if ( version_compare( $wgVersion, '1.32', '<' ) ) {
			...
			if ( $GLOBALS[ 'egChangelingEnableExternalLinkIcons' ] === true ) {
	...
	protected function prepareQuickTemplate() {
		...
		Hooks::run( 'ChangelingSkinTemplateOutputPageBeforeExec', [ $this, $tpl ] );
		return $tpl;
	}
	...
	protected function getLayoutFilePath() {
		return $GLOBALS[ 'egChangelingLayoutFile' ];
	}
	...
	protected function getThemeFilePath() {
		return $GLOBALS[ 'egChangelingThemeFile' ];
	}
}

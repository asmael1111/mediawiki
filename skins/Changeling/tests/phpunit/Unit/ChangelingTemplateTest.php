...
class ChangelingTemplateTest extends TestCase {
	...
	protected $cgChangelingLayoutFile = null;
	protected $cgChangelingThemeFile = null;

	protected function setUp(): void {
		parent::setUp();

		$this->cgChangelingLayoutFile = $GLOBALS['cgChangelingLayoutFile'];
		$this->cgChangelingThemeFile = $GLOBALS['cgChangelingThemeFile'];
	}

	protected function tearDown(): void {
		$GLOBALS['cgChangelingLayoutFile'] = $this->cgChangelingLayoutFile;
		$GLOBALS['cgChangelingThemeFile'] = $this->cgChangelingThemeFile;
	...
	public function testInaccessibleLayoutFileThrowsExeception() {
		...
		$GLOBALS['cgChangelingLayoutFile'] = 'setInaccessibleLayoutFile';

...
namespace Skins\Changeling\Tests\Unit\Hooks;

use Bootstrap\BootstrapManager;
use PHPUnit\Framework\TestCase;
use Skins\Changeling\Hooks\SetupAfterCache;
use WebRequest;

/**
 * @coversDefaultClass \Skins\Changeling\Hooks\SetupAfterCache
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class SetupAfterCacheTest extends TestCase {
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			'\Skins\Changeling\Hooks\SetupAfterCache',
	...
	public function testProcessWithValidExternalModuleWithoutScssVariables() {
		...
		$configuration = [
			'cgChangelingExternalStyleModules' => $mixedExternalStyleModules,
			'cgChangelingThemeFile'            => $this->dummyExternalModule,
			'IP'                              => 'notTestingIP',
	...
	//
	//	$configuration = [
	//		'cgChangelingExternalStyleModules' => $externalStyleModules,
	//		'IP'                              => 'notTestingIP',
	//		'wgScriptPath'                    => 'notTestingwgScriptPath',
	//		'wgStyleDirectory'                => 'notTestingwgStyleDirectory',
	//		'wgStylePath'                     => 'notTestingwgStylePath'
	...
	//
	//	$configuration = [
	//		'cgChangelingExternalStyleVariables'=> $externalStyleVariables,
	//		'IP'                               => 'notTestingIP',
	//		'wgScriptPath'                     => 'notTestingwgScriptPath',
	//		'wgStyleDirectory'                 => 'notTestingwgStyleDirectory',
	//		'wgStylePath'                      => 'notTestingwgStylePath'
	...
	//
	//	$configuration = [
	//		'cgChangelingAvailableLayoutFiles'  => $availableLayoutFiles,
	//		'cgChangelingLayoutFile'            => $defaultLayoutFile,
	//		'IP'                               => 'notTestingIP',
	//		'wgScriptPath'                     => 'notTestingwgScriptPath',
	//		'wgStyleDirectory'                 => 'notTestingwgStyleDirectory',
	//		'wgStylePath'                      => 'notTestingwgStylePath'
	...
	//	$this->assertEquals(
	//		$expectedLayoutfile,
	//		$configuration['cgChangelingLayoutFile']
	//	);
	//}
	...
	public function lateSettingsProvider() {
		...
		$provider[ ] = [
			[
				'cgChangelingEnableVisualEditor' => true,
			],
			[
				'cgChangelingEnableVisualEditor' => true,
			]
		...
		$provider[ ] = [
			...
			[
				'cgChangelingEnableVisualEditor' => true,
				'wgVisualEditorSupportedSkins'  => [ 'foo', 'changeling' ],
			]
		];
		...
		$provider[ ] = [
			[
				'cgChangelingEnableVisualEditor' => false,
				'wgVisualEditorSupportedSkins'  => [ 'changeling', 'foo' => 'changeling', 'foo' ],
			],
			[
				'cgChangelingEnableVisualEditor' => false,

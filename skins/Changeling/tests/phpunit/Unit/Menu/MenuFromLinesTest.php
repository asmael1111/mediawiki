...
namespace Skins\Changeling\Tests\Unit\Menu;

use Skins\Changeling\Menu\MenuFromLines;

/**
 * Class MenuFromLinesTest
 *
 * @coversDefaultClass \Skins\Changeling\Menu\MenuFromLines
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class MenuFromLinesTest extends \PHPUnit\Framework\TestCase {
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			'Skins\Changeling\Menu\MenuFromLines',
			$instance
		);
	}

...
/**
 * @coversDefaultClass \Skins\Changeling\Components\Modifications\ShowOnlyFor
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class ShowOnlyForTest extends GenericModificationTestCase {
	...
	protected $classUnderTest = '\Skins\Changeling\Components\Modifications\ShowOnlyFor';

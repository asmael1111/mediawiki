...
/**
 * @coversDefaultClass \Skins\Changeling\Components\FooterInfo
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class FooterInfoTest extends GenericComponentTestCase {
	...
	protected $classUnderTest = '\Skins\Changeling\Components\FooterInfo';
	...
	public function testGetHtml_GetsAllKeys() {
		...
		$changelingTemplate->expects( $this->at( 4 ) )
			->method( 'get' )

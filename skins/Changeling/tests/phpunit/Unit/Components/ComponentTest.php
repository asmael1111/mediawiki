...
class ComponentTest extends \PHPUnit\Framework\TestCase {
	...
	protected $classUnderTest = '\Skins\Changeling\Components\Component';
	...
	public function testCanConstruct() {
		...
		$instance = $this->getMockForAbstractClass( $this->classUnderTest, [ $changelingTemplate ] );
	...
	public function testGetIndent() {
		...
		$instance = $this->getMockForAbstractClass( $this->classUnderTest, [ $changelingTemplate, null,
			42 ] );
		$instance->expects( $this->any() )
			->method( 'getHtml' )
			->will( $this->returnValue( 'SomeHtml' ) );
	...
	protected function getChangelingSkinTemplateStub() {
		return $this->getMockBuilder( '\Skins\Changeling\ChangelingTemplate' )
			->disableOriginalConstructor()
			->getMock();
	}

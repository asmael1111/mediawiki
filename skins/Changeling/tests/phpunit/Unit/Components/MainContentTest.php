...
use Skins\Changeling\Components\MainContent;

/**
 * @coversDefaultClass \Skins\Changeling\Components\MainContent
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class MainContentTest extends GenericComponentTestCase {
	...
	protected $classUnderTest = '\Skins\Changeling\Components\MainContent';
	...
	public function testGetHtml_OnEmptyDataProperty() {
		...
		$instance = new MainContent( $changelingTemplate );

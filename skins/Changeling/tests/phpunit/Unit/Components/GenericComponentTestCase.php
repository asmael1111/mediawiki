...
use Skins\Changeling\Tests\Util\DocumentElementFinder;
use Skins\Changeling\Tests\Util\MockupFactory;
use Skins\Changeling\Tests\Util\XmlFileProvider;

/**
 * @coversDefaultClass \Skins\Changeling\Components\Component
 * @covers ::<private>
 * @covers ::<protected>
 *
...
class GenericComponentTestCase extends TestCase {
	...
	public function getTestObject( \DOMElement $domElement = null ) {
		if ( $this->testObject === null ) {
			...
			$this->testObject = new $this->classUnderTest( $changelingTemplate, $domElement );
		}
	...
	/**
	 * @return \Skins\Changeling\ChangelingTemplate
	 * @throws \MWException
	 */
	public function getChangelingSkinTemplateStub() {
		return MockupFactory::makeFactory( $this )->getChangelingSkinTemplateStub();
	}
	...
	public function getNameOfComponentUnderTest() {
		return str_replace( 'Skins\\Changeling\\Components\\', '', get_class( $this->getTestObject() ) );
	}

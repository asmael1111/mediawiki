...
The Brave skin is currently licensed under the GNU General Public License,
...
```
I understand and agree that the maintainer of the Brave skin shall have the
...
The current maintainer of the Brave skin is Stephan Gambke. He may appoint
...
* Right now the preferred installation method is to use Composer to install
  Brave and all its dependencies. This way I can maintain, that the skin
  ...
  compatibility.
* Brave itself might become part of a tarball, e.g. some pre-build,
...
Any open source license, that allows to maintain the Brave skin in a

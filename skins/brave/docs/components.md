...
``` xml
<structure xmlns="https://github.com/ProfessionalWiki/brave/layout/1.0">
  ...
</structure>
```
...
* `showTogglerText`:
  ...
  * Optional.
  ...
  Displays text next to the toggler icon. The text is defined in the system message `brave-toggler`.
...
* `flatten`
  ...
  * Optional.
  ...
  _MediaWiki:skin-brave-navmenu-flatten_ instead. If both the message and

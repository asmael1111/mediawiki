...
The author of the Brave skin is Stephan Gambke.
...
The "Brave Skin Logo" was derived from the ["Brave free
...
3.0](http://creativecommons.org/licenses/by/3.0/). The ["Brave Skin
Logo"](Brave.svg) itself
...
The Brave skin uses several other libraries. These, while not included

...
use Skins\Brave\Components\Html;

/**
 * @coversDefaultClass \Skins\Brave\Components\Html
 * @covers ::<private>
 * @covers ::<protected>
 *
 * @group   skins-brave
...
class HtmlTest extends GenericComponentTestCase {
	...
	protected $classUnderTest = '\Skins\Brave\Components\Html';
	...
	public function testGetHtml_OnSyntheticLayoutXml( \DOMElement $domElement ) {
		...
		$instance = new Html( $braveTemplate, $domElement );

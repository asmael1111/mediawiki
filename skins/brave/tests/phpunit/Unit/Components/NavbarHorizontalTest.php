...
use Skins\Brave\Components\NavbarHorizontal;

/**
 * @coversDefaultClass \Skins\Brave\Components\NavbarHorizontal
 * @covers ::<private>
 * @covers ::<protected>
 *
 * @group   skins-brave
...
class NavbarHorizontalTest extends GenericComponentTestCase {
	...
	protected $classUnderTest = '\Skins\Brave\Components\NavbarHorizontal';
	...
	public function testGetHtml_containsNavElement() {
		...
		$braveTemplate = $this->getMockBuilder( '\Skins\Brave\BraveTemplate' )
			->disableOriginalConstructor()
			->getMock();

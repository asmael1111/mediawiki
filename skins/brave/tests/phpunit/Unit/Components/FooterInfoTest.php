...
/**
 * @coversDefaultClass \Skins\Brave\Components\FooterInfo
 * @covers ::<private>
 * @covers ::<protected>
 *
 * @group   skins-brave
...
class FooterInfoTest extends GenericComponentTestCase {
	...
	protected $classUnderTest = '\Skins\Brave\Components\FooterInfo';

...
use Skins\Brave\Tests\Util\DocumentElementFinder;
use Skins\Brave\Tests\Util\MockupFactory;
use Skins\Brave\Tests\Util\XmlFileProvider;
...
class GenericComponentTestCase extends TestCase {
	...
	public function getTestObject( \DOMElement $domElement = null ) {
		if ( $this->testObject === null ) {
			...
			$this->testObject = new $this->classUnderTest( $braveTemplate, $domElement );
		}
	...
	/**
	 * @return \Skins\Brave\BraveTemplate
	 * @throws \MWException
	 */
	public function getBraveSkinTemplateStub() {
		return MockupFactory::makeFactory( $this )->getBraveSkinTemplateStub();
	}
	...
	public function getNameOfComponentUnderTest() {
		return str_replace( 'Skins\\Brave\\Components\\', '', get_class( $this->getTestObject() ) );
	}

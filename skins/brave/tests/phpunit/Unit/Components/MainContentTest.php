...
use Skins\Brave\Components\MainContent;

/**
 * @coversDefaultClass \Skins\Brave\Components\MainContent
 * @covers ::<private>
 * @covers ::<protected>
 *
 * @group   skins-brave
...
class MainContentTest extends GenericComponentTestCase {
	...
	protected $classUnderTest = '\Skins\Brave\Components\MainContent';
	...
	public function testGetHtml_OnEmptyDataProperty() {
		...
		$instance = new MainContent( $braveTemplate );

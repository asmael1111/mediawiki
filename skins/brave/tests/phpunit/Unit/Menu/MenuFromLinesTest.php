...
namespace Skins\Brave\Tests\Unit\Menu;

use Skins\Brave\Menu\MenuFromLines;

/**
 * Class MenuFromLinesTest
 *
 * @coversDefaultClass \Skins\Brave\Menu\MenuFromLines
 * @covers ::<private>
 * @covers ::<protected>
 *
 * @group   skins-brave
...
class MenuFromLinesTest extends \PHPUnit\Framework\TestCase {
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			'Skins\Brave\Menu\MenuFromLines',
			$instance
		);
	}

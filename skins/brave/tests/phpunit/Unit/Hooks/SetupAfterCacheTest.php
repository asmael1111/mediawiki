...
namespace Skins\Brave\Tests\Unit\Hooks;
...
/**
 * @coversDefaultClass \Skins\Brave\Hooks\SetupAfterCache
 * @covers ::<private>
 * @covers ::<protected>
 *
 * @group skins-brave
...
class SetupAfterCacheTest extends TestCase {
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			'\Skins\Brave\Hooks\SetupAfterCache',
	...
	public function testProcessWithValidExternalModuleWithoutScssVariables() {
		...
		$configuration = [
			'bnwBraveExternalStyleModules' => $mixedExternalStyleModules,
			'bnwBraveThemeFile'            => $this->dummyExternalModule,
			'IP'                              => 'notTestingIP',
	...
	//
	//	$configuration = [
	//		'bnwBraveExternalStyleModules' => $externalStyleModules,
	//		'IP'                              => 'notTestingIP',
	//		'wgScriptPath'                    => 'notTestingwgScriptPath',
	//		'wgStyleDirectory'                => 'notTestingwgStyleDirectory',
	//		'wgStylePath'                     => 'notTestingwgStylePath'
	...
	//
	//	$configuration = [
	//		'bnwBraveExternalStyleVariables'=> $externalStyleVariables,
	//		'IP'                               => 'notTestingIP',
	//		'wgScriptPath'                     => 'notTestingwgScriptPath',
	//		'wgStyleDirectory'                 => 'notTestingwgStyleDirectory',
	//		'wgStylePath'                      => 'notTestingwgStylePath'
	...
	//
	//	$configuration = [
	//		'bnwBraveAvailableLayoutFiles'  => $availableLayoutFiles,
	//		'bnwBraveLayoutFile'            => $defaultLayoutFile,
	//		'IP'                               => 'notTestingIP',
	//		'wgScriptPath'                     => 'notTestingwgScriptPath',
	//		'wgStyleDirectory'                 => 'notTestingwgStyleDirectory',
	//		'wgStylePath'                      => 'notTestingwgStylePath'
	...
	//	$this->assertEquals(
	//		$expectedLayoutfile,
	//		$configuration['bnwBraveLayoutFile']
	//	);
	//}
	...
	public function lateSettingsProvider() {
		...
		$provider[ ] = [
			[
				'bnwBraveEnableVisualEditor' => true,
			],
			[
				'bnwBraveEnableVisualEditor' => true,
			]
		...
		$provider[ ] = [
			[
				'bnwBraveEnableVisualEditor' => false,

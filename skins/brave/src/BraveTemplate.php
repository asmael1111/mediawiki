<?php
/**
 * File holding the BraveTemplate class
 *
...
/**
 * BaseTemplate class for the Brave skin
 *
 * @author Stephan Gambke
 * @since 1.0
 * @ingroup Skins
 */
class BraveTemplate extends BaseTemplate {
	 ...
	 *
	 * @throws \MWException
	 * @return \Skins\Brave\Components\Container
	 */
